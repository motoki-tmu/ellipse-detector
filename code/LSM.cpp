...
int CraterMatching(vector<Ellipse>& ellipses) 
{
	typedef struct {double x; double y;} point; // pointという名前の構造体を宣言

	// csvファイルからmodelクレータ情報を取り出すための配列arrayを作成
	vector<vector<double>> array(NUM_CRATERS, vector<double>(4, 0.0));
	ifstream stream("model_info.csv"); // num, x, y, r
	string line;
	int row = 0;
	...
	vector<vector<double>> line_combi(NUM_COMBINATIONS, vector<double>(4, 0.0));

	// csvファイルの中身をline_combi配列に格納
	ifstream stream2("line_combi_sorted.csv"); // key, length, a_num, b_num
	string line2;
	int row2 = 0;
    ...
    //cout << line_combi[406][0] << endl;

	vector<vector<double>> l_c(3, vector<double>(NUM_COMBINATIONS, 0.0));
	...
	unordered_multimap<int, int> line_length;
	for (int i = 0; i < 7; i++) {
		line_length.insert(make_pair(20, i));
	}
	for (int i = 7; i < 29; i++) {
		line_length.insert(make_pair(30, i));
	}
	for (int i = 29; i < 66; i++) {
		line_length.insert(make_pair(40, i));
	}
	for (int i = 66; i < 115; i++) {
		line_length.insert(make_pair(50, i));
	}
	for (int i = 115; i < 177; i++) {
		line_length.insert(make_pair(60, i));
	}
	for (int i = 177; i < 244; i++) {
		line_length.insert(make_pair(70, i));
	}
	for (int i = 244; i < 320; i++) {
		line_length.insert(make_pair(80, i));
	}
	for (int i = 320; i < 406; i++) {
		line_length.insert(make_pair(90, i));
	}
	for (int i = 406; i < 489; i++) {
		line_length.insert(make_pair(100, i));
	}
	for (int i = 489; i < 570; i++) {
		line_length.insert(make_pair(110, i));
	}
	for (int i = 570; i < 672; i++) {
		line_length.insert(make_pair(120, i));
	}
	for (int i = 672; i < 795; i++) {
		line_length.insert(make_pair(130, i));
	}
	for (int i = 795; i < 893; i++) {
		line_length.insert(make_pair(140, i));
	}
	for (int i = 893; i < 1018; i++) {
		line_length.insert(make_pair(150, i));
	}
	for (int i = 1018; i < 1135; i++) {
		line_length.insert(make_pair(160, i));
	}
	for (int i = 1135; i < 1273; i++) {
		line_length.insert(make_pair(170, i));
	}
	for (int i = 1273; i < 1400; i++) {
		line_length.insert(make_pair(180, i));
	}
	for (int i = 1400; i < 1518; i++) {
		line_length.insert(make_pair(190, i));
	}
	for (int i = 1518; i < 1651; i++) {
		line_length.insert(make_pair(200, i));
	}
	for (int i = 1651; i < 1787; i++) {
		line_length.insert(make_pair(210, i));
	}
	for (int i = 1787; i < 1939; i++) {
		line_length.insert(make_pair(220, i));
	}
    for (int i = 1939; i < 2085; i++) {
		line_length.insert(make_pair(230, i));
	}
    for (int i = 2085; i < 2239; i++) {
		line_length.insert(make_pair(240, i));
	}
    for (int i = 2239; i < 2363; i++) {
		line_length.insert(make_pair(250, i));
	}
    for (int i = 2363; i < 2518; i++) {
		line_length.insert(make_pair(260, i));
	}
    for (int i = 2518; i < 2674; i++) {
		line_length.insert(make_pair(270, i));
	}
    for (int i = 2674; i < 2836; i++) {
		line_length.insert(make_pair(280, i));
	}
    for (int i = 2836; i < 2975; i++) {
		line_length.insert(make_pair(290, i));
	}
    for (int i = 2975; i < 3127; i++) {
		line_length.insert(make_pair(300, i));
	}
    for (int i = 3127; i < 3286; i++) {
		line_length.insert(make_pair(310, i));
	}
    for (int i = 3286; i < 3421; i++) {
		line_length.insert(make_pair(320, i));
	}
    for (int i = 3421; i < 3578; i++) {
		line_length.insert(make_pair(330, i));
	}
    for (int i = 3578; i < 3711; i++) {
		line_length.insert(make_pair(340, i));
	}
    for (int i = 3711; i < 3839; i++) {
		line_length.insert(make_pair(350, i));
	}
    for (int i = 3839; i < 4002; i++) {
		line_length.insert(make_pair(360, i));
	}
    for (int i = 4002; i < 4161; i++) {
		line_length.insert(make_pair(370, i));
	}
    for (int i = 4161; i < 4301; i++) {
		line_length.insert(make_pair(380, i));
	}
    for (int i = 4301; i < 4442; i++) {
		line_length.insert(make_pair(390, i));
	}
    for (int i = 4442; i < 4579; i++) {
		line_length.insert(make_pair(400, i));
	}
    for (int i = 4579; i < 4721; i++) {
		line_length.insert(make_pair(410, i));
	}
    for (int i = 4721; i < 4852; i++) {
		line_length.insert(make_pair(420, i));
	}
    for (int i = 4852; i < 4972; i++) {
		line_length.insert(make_pair(430, i));
	}
    for (int i = 4972; i < 5111; i++) {
		line_length.insert(make_pair(440, i));
	}
    for (int i = 5111; i < 5230; i++) {
		line_length.insert(make_pair(450, i));
	}
    for (int i = 5230; i < 5352; i++) {
		line_length.insert(make_pair(460, i));
	}
    for (int i = 5352; i < 5475; i++) {
		line_length.insert(make_pair(470, i));
	}
    for (int i = 5475; i < 5595; i++) {
		line_length.insert(make_pair(480, i));
	}
    for (int i = 5595; i < 5713; i++) {
		line_length.insert(make_pair(490, i));
	}
    for (int i = 5713; i < 5815; i++) {
		line_length.insert(make_pair(500, i));
	}
    for (int i = 5815; i < 5916; i++) {
		line_length.insert(make_pair(510, i));
	}
    for (int i = 5916; i < 6001; i++) {
		line_length.insert(make_pair(520, i));
	}
    for (int i = 6001; i < 6118; i++) {
		line_length.insert(make_pair(530, i));
	}
    for (int i = 6118; i < 6203; i++) {
		line_length.insert(make_pair(540, i));
	}
    for (int i = 6203; i < 6279; i++) {
		line_length.insert(make_pair(550, i));
	}
    for (int i = 6279; i < 6371; i++) {
		line_length.insert(make_pair(560, i));
	}
    for (int i = 6371; i < 6444; i++) {
		line_length.insert(make_pair(570, i));
	}
    for (int i = 6444; i < 6503; i++) {
		line_length.insert(make_pair(580, i));
	}
    for (int i = 6503; i < 6567; i++) {
		line_length.insert(make_pair(590, i));
	}
    for (int i = 6567; i < 6630; i++) {
		line_length.insert(make_pair(600, i));
	}
    for (int i = 6630; i < 6682; i++) {
		line_length.insert(make_pair(610, i));
	}
    for (int i = 6682; i < 6722; i++) {
		line_length.insert(make_pair(620, i));
	}
    for (int i = 6722; i < 6775; i++) {
		line_length.insert(make_pair(630, i));
	}
    for (int i = 6775; i < 6814; i++) {
		line_length.insert(make_pair(640, i));
	}
    for (int i = 6814; i < 6838; i++) {
		line_length.insert(make_pair(650, i));
	}
    for (int i = 6838; i < 6871; i++) {
		line_length.insert(make_pair(660, i));
	}
    for (int i = 6871; i < 6900; i++) {
		line_length.insert(make_pair(670, i));
	}
    for (int i = 6900; i < 6918; i++) {
		line_length.insert(make_pair(680, i));
	}
    for (int i = 6918; i < 6934; i++) {
		line_length.insert(make_pair(690, i));
	}
    for (int i = 6934; i < 6945; i++) {
		line_length.insert(make_pair(700, i));
	}
    for (int i = 6945; i < 6962; i++) {
		line_length.insert(make_pair(710, i));
	}
    for (int i = 6962; i < 6972; i++) {
		line_length.insert(make_pair(720, i));
	}
    for (int i = 6972; i < 6979; i++) {
		line_length.insert(make_pair(730, i));
	}
    for (int i = 6979; i < 6986; i++) {
		line_length.insert(make_pair(740, i));
	}
    for (int i = 6986; i < 6995; i++) {
		line_length.insert(make_pair(750, i));
	}
    for (int i = 6995; i < 7001; i++) {
		line_length.insert(make_pair(760, i));
	}
    for (int i = 7001; i < 7006; i++) {
		line_length.insert(make_pair(770, i));
	}
    for (int i = 7006; i < 7010; i++) {
		line_length.insert(make_pair(780, i));
	}
    for (int i = 7010; i < 7013; i++) {
		line_length.insert(make_pair(790, i));
	}
    for (int i = 7013; i < 7015; i++) {
		line_length.insert(make_pair(800, i));
	}

    // world（未完成）
    int num_world = ellipses.size();
    vector<point> world(num_world);
    ...
    if (best > 0)
    {
        cout << "matching points: " << best << endl;
        cout << "deltatheta: " << best_deltatheta << endl;
        cout << "scale: " << best_s << endl;
        cout << "estimated result: " << estimate_m_x << ", " << estimate_m_y << endl;
    }
    else
    {
        cout << "unestimable" << endl;
    }
		...
		for (auto itr = range.first; itr != range.second; ++itr) // キーの範囲（開始番号から終了番号）内をループ
		{
			...
			if (segment_value1 >= R) 
			{
				if (kaitenn_degree_number == 1)
				{
                    ...
                    cout << "matching points: " << segment_value1 << endl; 
                    cout << "estimated result: " << estimate_m_x << ", " << estimate_m_y << endl;
			...
			if (segment_value2 >= R)
			{
				if (kaitenn_degree_number == 2)
				{
					...
					//printf("ロボットアームの移動量は，x軸方向に%f，y軸方向に%f\n", robotarm_idouryou_x, robotarm_idouryou_y);
                    cout << "matching points: " << segment_value2 << endl; 
					cout << "estimated result: " << estimate_m_x << ", " << estimate_m_y << endl;
